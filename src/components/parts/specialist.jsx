            ...
            <Card sx={{ border: 0, boxShadow: "unset" }}>
              <CardActionArea>
                ...
                <CardContent
                  ...
                  sx={{ backgroundColor: "#6565651c" }}
                >
                  <Typography
                    gutterBottom
                    textAlign={"center"}
                    className="NotoSansThai ts-1"
                    component="div"
                  >
                  ...
                  >
                    {item.topics_json &&
                      item.topics_json.length > 0 &&
                      item.topics_json.map((topic) => (
                        <div className="tag" key={topic.id}>
                          {" "}
                          <img
                            src={topic.icon_file_name}
                            className="me-2 sm-icon"
                          />{" "}
                          {topic.name}
                        </div>
                      ))}
