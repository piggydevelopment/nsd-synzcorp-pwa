      ...
      <Box component="form" autoComplete="off" onSubmit={handleSubmit} pt={5}>
        <Stack sx={{ mx: 3 }} spacing={4}>
          ...
          <FormControl fullWidth>
            <InputLabel id="psychiatricTreatment-label">
              เคยรักษาทางจิตเวชมาก่อนหรือไม่?
            </InputLabel>
            <Select
              ...
              className="NotoSansThai"
              onChange={(e) =>
                setFormData({ ...formData, received_treatment: e.target.value })
              }
            >
          ...
          >
            <FormControlLabel
              control={
                <Checkbox
                  checked={formData.addicted_coffee}
                  style={{ width: "45px", height: "45px" }}
                />
              }
              name="addicted_coffee"
              value="addicted_coffee"
              label="กาแฟ"
            />
            <FormControlLabel
              control={
                <Checkbox
                  checked={formData.addicted_alcohol}
                  style={{ width: "45px", height: "45px" }}
                />
              }
              name="addicted_alcohol"
              value="addicted_alcohol"
              label="แอลกอฮอล์"
            />
            <FormControlLabel
              control={
                <Checkbox
                  checked={formData.addicted_cigarettes}
                  style={{ width: "45px", height: "45px" }}
                />
              }
              name="addicted_cigarettes"
              value="addicted_cigarettes"
              label="บุหรี่"
            />
          </FormGroup>
